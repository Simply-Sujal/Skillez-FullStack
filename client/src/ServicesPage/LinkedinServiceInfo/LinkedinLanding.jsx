...
const ResumeBuildingInfoLanding = () => {
    ...
    return (
        <div className='w-full h-[calc(100vh-5rem)]'>
            <div className="bg-cover bg-[url('https://media.cybernews.com/images/750w/2021/04/500M-linkedin-leak-featured-img.jpg')] brightness-100 bg-center bg-no-repeat h-full w-full">
                <Fade duration={1000} distance="30px" bottom>
                    <div className="container mx-auto flex flex-col my-auto align-middle h-full max-w-[1290px]">
                        <div className='my-auto mx-auto lg:mx-0 w-10/12 lg:w-2/4'>
                            <h1 className="text-4xl md:text-7xl mb-4 text-white font-monts"><span className='text-blue-500'>Let’s talk</span> about Linkedin Profile Setup Service</h1>
